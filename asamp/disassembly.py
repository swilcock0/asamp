...
class Assembly(object):
    ...
    def plot_liaisons(self, pyplot=False):
        graph = ig.Graph()
...
#             print(element)
    ...
    #     #input()
    #     test.disassembly_tree(60*60*1.5, min_freedom=0, depth_mult=20)
    #     test.load_tree()
    #     test.plot_igraph(pyplot=False)
    # disassemble()
